...
import { i as requestHandler, r as getResponse } from "./request-response-CP9bMnp0.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D07JzWqn.mjs");
